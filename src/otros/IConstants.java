...
public interface IConstants {
	...
	public static int PANTALLA_ANCHURA = 500;
	public static int PANTALLA_ALTURA = 250;
	...
	int START_OF_URL_IN_HREF_TAGS = 6;
	int START_OF_TEXT_IN_P_TAGS = 3;
	int END_OF_HREF_TAGS = 2;
	int END_OF_P_TAGS = 4;
}
